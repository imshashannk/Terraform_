...
module "ec2" {
  ...
  public_subnets = module.vpc.public_subnets  # Passing the correct output from the VPC module
}
...
module "ec2_instance2" {
  ...
  instance_type_value = var.instance_type_value
  ami_value           = var.ami_value
  public_subnets = module.vpc.public_subnets  # Passing the correct output here too
}
